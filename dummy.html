    ...
    <main style="margin-top: 90px;">
        <section class="bg-dark main-banner">
            <div class="container d-flex overflow-h flex-column flex-md-row">
                ...
                <div class="container d-flex flex-column justify-content-end" style="min-width: 740px;">
        ...
        <body>
            ...
            <section class="hs-c-smart-section sbg-light">
            ...
            <section class="hs-d-smart-section bg-dark">
            ...
            <section class="hs-e-smart-section bg-light">
            ...
            <section class="hs-f-section">
                <div class="container">
                    <div class="container hs-f-content d-flex align-items-center gap-0 align-items-stretch row">
            ...
            <section class="hs-g-portfolio py-5">
            ...
            <section class="hs-h-smart-section">
            ...
            <section class="hs-i-lead-section py-5">
            ...
            <section class="hs-j-smart-section bg-dark">
            ...
            <section class="hs-k-section">
                <div class="container">
                    <div class="container hs-k-content d-flex align-items-center gap-0 align-items-stretch row">
            ...
            <section class="hs-m-audit-section py-5">
