...
<head>
    ...
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-5BQSFK44');</script>
    <!-- End Google Tag Manager -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-LHMLQ9RB4G"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-LHMLQ9RB4G');
    </script>
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "name": "iYnix Digital",
  "url": "https://grow.iynixdigital.com/",
  "logo": "https://grow.iynixdigital.com/logo.png",
  "description": "iYnix Digital is a results‑driven digital marketing agency offering tailored online marketing solutions to help businesses grow, including SEO, PPC, web design, social media marketing, and more.",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "2161, GA 30002",
  ...
  "sameAs": [
    "https://www.facebook.com/iynixdigital",
    "https://www.linkedin.com/company/iynix-digital"
  ]
}
</script>
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is your decision about selecting the appropriate marketing strategy in my market?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We look at your audience, competitors and market demand and then select the channels that would best suit your business and region: SEO, Google Ads, Meta Ads or AI-led growth."
      }
    },
    {
      "@type": "Question",
      "name": "What is your measure of success in various markets?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We measure success based on ROI, lead quality, conversion rate and sustainable growth metrics."
      }
    },
    {
      "@type": "Question",
      "name": "I have had previous experience with agencies. How are you different?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We measure success based on ROI, lead quality, conversion rate and sustainable growth metrics."
      }
    ...
    {
      "@type": "Question",
      "name": "Will you be able to assist us in scaling out of one country or region?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We measure success based on ROI, lead quality, conversion rate and sustainable growth metrics."
      }
    ...
    {
      "@type": "Question",
      "name": "Will I have visibility into performance and progress?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We focus on performance driven marketing backed by data, transparency and optimization."
      }
    }
  ]
}
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5BQSFK44" height="0" width="0"
    ...
    <section class="bg-dark main-banner">
        <div class="container d-flex overflow-h flex-column flex-md-column flex-lg-row">
            ...
            <div class="container mt-md-5 mt-sm-4 mt-3 mt-lg-0">
    ...
    <section class="hs-c-smart-section sbg-light section-gap">
        ...
        <div class="container text-center">
            ...
            <!-- Cards -->
            <div class="row justify-content-center g-4 mb-5 container mx-0">
